...
- `src/app/page.tsx` — page composition (Header, ArchiveGallery, AccessForm)
- `src/components/Header.tsx` — top-left title / top-right issue metadata
...
- `src/components/AccessForm.tsx` — bottom-center email capture
